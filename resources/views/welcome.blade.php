                        ...
                        <div class="row d-flex align-items-center mt-5 pt-5">
                            <div class="col-md-6">
                                <div class="banner-content">
                                    ...
                                    <a href="#testimonials"
                                        class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Read More</a>
                                </div>
                            </div>
                            <div class="col-md-5 mt-5">
                                <div class="image-holder mt-5">
                                    <img src="images/car.PNG" alt="banner">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide text-center d-flex justify-content-center">
                                <div class="review-item col-md-10">
                                    ...
                                    <blockquote>“Some of the top Mercedes models include the Mercedes-Benz S-Class, Mercedes-Benz E-Class, Mercedes-Benz C-Class, and the Mercedes-Benz G-Class. Each model offers a unique combination of luxury, performance, and style. Have you ever driven or considered owning a Mercedes”</blockquote>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div
                    ...
                    <div class="col-md-5 col-sm-12">
                        <form class="subscription-form validate" method="POST" action="{{ url('/email') }}">
                            @csrf
